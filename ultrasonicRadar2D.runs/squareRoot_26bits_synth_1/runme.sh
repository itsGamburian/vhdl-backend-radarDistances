...
HD_PWD='C:/Users/Mike/Documents/ECE_492_SeniorProject/ultrasonicRadar2D/ultrasonicRadar2D.runs/squareRoot_26bits_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log squareRoot_26bits.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source squareRoot_26bits.tcl
