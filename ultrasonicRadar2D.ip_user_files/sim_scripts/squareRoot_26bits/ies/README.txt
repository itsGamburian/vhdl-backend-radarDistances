...
#
# Generated by export_simulation on Wed Feb 14 17:23:56 -0800 2018
#
################################################################################
...
switch to the './squareRoot_26bits.sh' script.

./squareRoot_26bits.sh -reset_run
...
./squareRoot_26bits.sh -noclean_files

For more information on the script, please type './squareRoot_26bits.sh -help'.
